...
public class FixedTaskController {
    ...
    @Autowired
    public FixedTaskRepositoryCustomImpl fixedTaskRepositoryCustomImpl;

    @GetMapping(value = "/fixedtasks")
    public List<FixedTask> getAllFixedTask(@RequestParam String idExploitation, @RequestParam String idBuilding,
    ...
    public List<FixedTask> createFixedTask(@RequestParam String idExploitation, @RequestParam String idBuilding,
            @RequestParam String idLot, @RequestBody ArrayList<FixedTask> fixedTasks) {
        ...
        for (int i = 0; i < fixedTasks.size(); i++) {
            ...
            FixedTask insertedFixedTask = fixedTaskRepositoryCustomImpl.insert(idExploitation, idBuilding, idLot,
                    fixedTask);
