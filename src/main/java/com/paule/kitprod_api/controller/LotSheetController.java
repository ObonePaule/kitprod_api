...
public class LotSheetController {
    ...
    public List<LotSheet> getAllLotSheets(@RequestParam String idExploitation, @RequestParam String idBuilding,
    ...
    public LotSheet createLotSheet(@RequestParam String idExploitation, @RequestParam String idBuilding,
            @RequestParam String idLot, @RequestBody LotSheet lotSheet) {
